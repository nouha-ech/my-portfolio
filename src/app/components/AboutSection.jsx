...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        ...
        <li>Complete JAVA Programming Course | Udemy</li>
        <li> PHP & MySQL for Web Developers | Udemy</li>
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>
          Achieved 3rd Place in the first edition of the AI & inclusion
          économique des jeunes Hackathon{" "}
        </li>
      </ul>
    ),
  },
